...
The shared header includes a high-contrast mode toggle for improved readability. The preference is stored in the browser and restored automatically on later page loads.
